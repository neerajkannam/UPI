...
# =====================================================
# Load Logistic Regression Artifact
# =====================================================
...
if st.session_state.page == "input":
    ...
    st.markdown('<div class="subtitle">Logistic Regression Based Fraud Detection</div>', unsafe_allow_html=True)
    st.write("")
...
# =====================================================
    ...
    if is_fraud:
        ...
        <div class="result-card safe">
            ...
            Probability: {prob:.2f}
            <div class="badge">LOW RISK</div>
        </div>
        """, unsafe_allow_html=True)

    st.progress(min(prob, 1.0))
    st.caption(f"Model: Logistic Regression | Threshold: {threshold}")
